...
<figure id="fig-1-4"><img alt="A single ramp with a gentle incline cutting across stone steps." src="/images/fig-1-04-ramp-stairs.jpg"/><figcaption><span class="fig-number">Fig 1.4:</span> This ramp could be used just as easily by cyclists or parents pushing strollers as by people using wheelchairs. It doesn’t look out of place. In fact, it contributes to the architecture.</figcaption></figure>
...
<figure id="fig-1-10" class="images-pair"><img alt="Zoomed out web page with a box overlayed showing a zoomed-in section of the same page centered on the mouse cursor." src="/images/fig-1-10-a-zoomed-picture.png"/><img alt="The same web page zoomed in." src="/images/fig-1-10-b-zoomed-all.png"/><figcaption><span class="fig-number">Fig 1.10:</span> Screen magnifier using picture-in-picture magnification (left), and the same desktop using full-screen magnification (right).</figcaption></figure>
...
<figure id="fig-1-11"><img alt="Screen magnifier box centered over a Buy tickets button where the button text and outline is pixelated." src="/images/fig-1-11-button-zoom.png"/><figcaption><span class="fig-number">Fig 1.10:</span> When an image is magnified, the text can become pixelated.</figcaption></figure>
