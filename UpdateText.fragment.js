...
export default () => kitten.html`
    ...
    <p>Perhaps someday I (Laura) will find time to write a second edition, but first I wanted to make the book freely available for the web community who have generously shared their knowledge with me.</p>
`